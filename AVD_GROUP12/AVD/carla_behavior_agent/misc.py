...
#------------------------------------------------------------------
def get_trafficelement_trigger_location(traffic_element):
    """
    ...
    base_transform = traffic_element.get_transform()
    base_rot = base_transform.rotation.yaw
    area_loc = base_transform.transform(traffic_element.trigger_volume.location)
    area_ext = traffic_element.trigger_volume.extent
